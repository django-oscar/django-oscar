...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'ProductAlert.email'
        db.alter_column(u'customer_productalert', 'email', self.gf('django.db.models.fields.EmailField')(default='', max_length=75))

        # Changing field 'ProductAlert.key'
        db.alter_column(u'customer_productalert', 'key', self.gf('django.db.models.fields.CharField')(default='', max_length=128))
    ...
    def backwards(self, orm):
        ...
        # Changing field 'ProductAlert.email'
        db.alter_column(u'customer_productalert', 'email', self.gf('django.db.models.fields.EmailField')(max_length=75, null=True))

        # Changing field 'ProductAlert.key'
        db.alter_column(u'customer_productalert', 'key', self.gf('django.db.models.fields.CharField')(max_length=128, null=True))
