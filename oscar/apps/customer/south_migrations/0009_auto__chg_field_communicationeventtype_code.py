...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column(u'customer_communicationeventtype', 'code', self.gf('oscar.models.fields.autoslugfield.AutoSlugField')(allow_duplicates=False, max_length=128, separator=u'_', unique=True, populate_from='name', overwrite=False))

    def backwards(self, orm):

        # Changing field 'CommunicationEventType.code'
        db.alter_column(u'customer_communicationeventtype', 'code', self.gf('oscar.models.fields.autoslugfield.AutoSlugField')(populate_from='name', allow_duplicates=False, max_length=128, separator=u'-', unique=True, overwrite=False))
