...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column(u'customer_communicationeventtype', 'sms_template', self.gf('django.db.models.fields.CharField')(max_length=170, null=True))

    def backwards(self, orm):

        # Changing field 'CommunicationEventType.sms_template'
        db.alter_column(u'customer_communicationeventtype', 'sms_template', self.gf('django.db.models.fields.CharField')(default='', max_length=170))
