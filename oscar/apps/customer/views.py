...
class AccountAuthView(TemplateView):
    ...
    def get_context_data(self, *args, **kwargs):
        ...
        context['login_form'] = self.login_form_class(prefix=self.login_prefix)
        context['registration_form'] = self.registration_form_class(prefix=self.registration_prefix)
        return context
    ...
    def post(self, request, *args, **kwargs):
        ...
        if u'login_submit' in self.request.POST:
            login_form = self.login_form_class(prefix=self.login_prefix, data=request.POST)
        ...
        if u'registration_submit' in self.request.POST:
            registration_form = self.registration_form_class(prefix=self.registration_prefix, data=request.POST)
