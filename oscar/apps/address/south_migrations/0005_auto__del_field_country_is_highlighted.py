...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Country.is_highlighted'
        db.delete_column('address_country', 'is_highlighted')


    def backwards(self, orm):
        # Adding field 'Country.is_highlighted'
        db.add_column('address_country', 'is_highlighted',
