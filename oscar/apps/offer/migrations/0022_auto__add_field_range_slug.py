...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Range.slug'
        db.add_column(u'offer_range', 'slug',
                      self.gf('django.db.models.fields.SlugField')(max_length=128, unique=True, null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Range.slug'
        db.delete_column(u'offer_range', 'slug')
