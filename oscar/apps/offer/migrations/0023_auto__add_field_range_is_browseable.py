...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Range.is_browseable'
        db.add_column(u'offer_range', 'is_browseable',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Range.is_browseable'
        db.delete_column(u'offer_range', 'is_browseable')
    ...
    models = {
        ...
        u'offer.range': {
            ...
            'is_browseable': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            'name': ('django.db.models.fields.CharField', [], {'unique': 'True', 'max_length': '128'}),
            'proxy_class': ('django.db.models.fields.CharField', [], {'default': 'None', 'max_length': '255', 'unique': 'True', 'null': 'True', 'blank': 'True'}),
            'slug': ('django.db.models.fields.SlugField', [], {'max_length': '128', 'unique': 'True', 'null': 'True'})
        }
