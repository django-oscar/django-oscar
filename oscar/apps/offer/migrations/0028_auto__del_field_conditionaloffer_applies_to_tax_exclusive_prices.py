...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'ConditionalOffer.applies_to_tax_exclusive_prices'
        db.delete_column(u'offer_conditionaloffer', 'applies_to_tax_exclusive_prices')


    def backwards(self, orm):
        # Adding field 'ConditionalOffer.applies_to_tax_exclusive_prices'
        db.add_column(u'offer_conditionaloffer', 'applies_to_tax_exclusive_prices',
