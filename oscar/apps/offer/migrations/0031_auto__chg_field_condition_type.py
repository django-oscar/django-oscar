...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column(u'offer_condition', 'type', self.gf('django.db.models.fields.CharField')(default='', max_length=128))

    def backwards(self, orm):

        # Changing field 'Condition.type'
        db.alter_column(u'offer_condition', 'type', self.gf('django.db.models.fields.CharField')(max_length=128, null=True))
