...
class Migration(DataMigration):
    ...
    def forwards(self, orm):
        # Ensure all descriptions are empty string, not null.  This is required
        # before we change the field itself.
        ConditionalOffer = orm['offer.ConditionalOffer']
        ConditionalOffer.objects.filter(
            description__isnull=True).update(description="")
