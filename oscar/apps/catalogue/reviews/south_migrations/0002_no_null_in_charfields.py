...
class Migration(DataMigration):
    ...
    def forwards(self, orm):
        orm.ProductReview.objects.filter(name__isnull=True).update(name='')
        orm.ProductReview.objects.filter(homepage__isnull=True).update(homepage='')
        orm.ProductReview.objects.filter(email__isnull=True).update(email='')
