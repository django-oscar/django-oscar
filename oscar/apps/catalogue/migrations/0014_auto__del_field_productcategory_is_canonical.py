...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'ProductCategory.is_canonical'
        db.delete_column(u'catalogue_productcategory', 'is_canonical')


    def backwards(self, orm):
        # Adding field 'ProductCategory.is_canonical'
        db.add_column(u'catalogue_productcategory', 'is_canonical',
