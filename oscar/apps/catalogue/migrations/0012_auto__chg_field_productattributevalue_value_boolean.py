...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column(u'catalogue_productattributevalue', 'value_boolean', self.gf('django.db.models.fields.NullBooleanField')(null=True))

    def backwards(self, orm):

        # Changing field 'ProductAttributeValue.value_boolean'
        db.alter_column(u'catalogue_productattributevalue', 'value_boolean', self.gf('django.db.models.fields.BooleanField')())
