...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'ProductContributor.role'
        db.alter_column('catalogue_productcontributor', 'role_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['catalogue.ContributorRole'], null=True))
    ...
    models = {
        ...
        'catalogue.category': {
            ...
            'full_name': ('django.db.models.fields.CharField', [], {'max_length': '500', 'db_index': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
