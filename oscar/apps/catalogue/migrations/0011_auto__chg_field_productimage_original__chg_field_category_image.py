...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column('catalogue_productimage', 'original', self.gf('django.db.models.fields.files.ImageField')(max_length=255))

        # Changing field 'Category.image'
        db.alter_column('catalogue_category', 'image', self.gf('django.db.models.fields.files.ImageField')(max_length=255, null=True))

    def backwards(self, orm):

        # Changing field 'ProductImage.original'
        db.alter_column('catalogue_productimage', 'original', self.gf('django.db.models.fields.files.ImageField')(max_length=100))

        # Changing field 'Category.image'
        db.alter_column('catalogue_category', 'image', self.gf('django.db.models.fields.files.ImageField')(max_length=100, null=True))
