...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Product.product_class'
        db.alter_column(u'catalogue_product', 'product_class_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, on_delete=models.PROTECT, to=orm['catalogue.ProductClass']))

    def backwards(self, orm):

        # Changing field 'Product.product_class'
        db.alter_column(u'catalogue_product', 'product_class_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['catalogue.ProductClass']))
