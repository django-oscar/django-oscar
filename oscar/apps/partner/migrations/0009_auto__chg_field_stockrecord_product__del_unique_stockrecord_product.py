...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.delete_unique(u'partner_stockrecord', ['product_id'])


        # Changing field 'StockRecord.product'
        db.alter_column(u'partner_stockrecord', 'product_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['catalogue.Product']))

    def backwards(self, orm):

        # Changing field 'StockRecord.product'
        db.alter_column(u'partner_stockrecord', 'product_id', self.gf('django.db.models.fields.related.OneToOneField')(unique=True, to=orm['catalogue.Product']))
        # Adding unique constraint on 'StockRecord', fields ['product']
        db.create_unique(u'partner_stockrecord', ['product_id'])
