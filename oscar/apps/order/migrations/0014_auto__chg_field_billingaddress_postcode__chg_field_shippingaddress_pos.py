...
class Migration(SchemaMigration):
    ...
    def backwards(self, orm):
        ...
        # Changing field 'BillingAddress.postcode'
        db.alter_column(u'order_billingaddress', 'postcode', self.gf('django.db.models.fields.CharField')(max_length=64, null=True))

        # Changing field 'ShippingAddress.postcode'
        db.alter_column(u'order_shippingaddress', 'postcode', self.gf('django.db.models.fields.CharField')(max_length=64, null=True))
