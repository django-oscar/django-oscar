...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Renaming column for 'Order.basket_id' to match new field type.
        db.rename_column(u'order_order', 'basket_id', 'basket_id_id')
        # Changing field 'Order.basket_id'
        db.alter_column(u'order_order', 'basket_id_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['basket.Basket'], null=True, on_delete=models.SET_NULL))
        # Adding index on 'Order', fields ['basket_id']
        db.create_index(u'order_order', ['basket_id_id'])


    def backwards(self, orm):
        # Removing index on 'Order', fields ['basket_id']
        db.delete_index(u'order_order', ['basket_id_id'])


        # Renaming column for 'Order.basket_id' to match new field type.
        db.rename_column(u'order_order', 'basket_id_id', 'basket_id')
        # Changing field 'Order.basket_id'
        db.alter_column(u'order_order', 'basket_id', self.gf('django.db.models.fields.PositiveIntegerField')(null=True))
    ...
    models = {
        ...
        u'order.order': {
            ...
            'basket_id': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['basket.Basket']", 'null': 'True', 'on_delete': 'models.SET_NULL', 'blank': 'True'}),
