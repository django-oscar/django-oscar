...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AddField(
            ...
            field=models.ForeignKey(related_name=b'order_entity_content', blank=True, editable=False, to='contenttypes.ContentType', null=True),
        ...
        migrations.AddField(
            model_name='lineattribute',
            name='value_option',
            field=models.ForeignKey(related_name=b'order_value_option', verbose_name='Value option', blank=True, to='catalogue.AttributeOption', null=True),
            preserve_default=True,
        ),
        migrations.AddField(
            model_name='lineattribute',
