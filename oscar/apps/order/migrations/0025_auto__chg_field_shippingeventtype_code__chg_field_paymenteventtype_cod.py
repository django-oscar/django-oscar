...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'ShippingEventType.code'
        db.alter_column(u'order_shippingeventtype', 'code', self.gf('oscar.models.fields.autoslugfield.AutoSlugField')(allow_duplicates=False, max_length=128, separator=u'-', unique=True, populate_from='name', overwrite=False))

        # Changing field 'PaymentEventType.code'
        db.alter_column(u'order_paymenteventtype', 'code', self.gf('oscar.models.fields.autoslugfield.AutoSlugField')(allow_duplicates=False, max_length=128, separator=u'-', unique=True, populate_from='name', overwrite=False))

    def backwards(self, orm):

        # Changing field 'ShippingEventType.code'
        db.alter_column(u'order_shippingeventtype', 'code', self.gf('django.db.models.fields.SlugField')(max_length=128, unique=True))

        # Changing field 'PaymentEventType.code'
        db.alter_column(u'order_paymenteventtype', 'code', self.gf('django.db.models.fields.SlugField')(max_length=128, unique=True))
