...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('order_orderdiscount', 'offer_name',
                      self.gf('django.db.models.fields.CharField')(max_length=128, null=True, db_index=True),
                      keep_default=False)


        # Changing field 'LineAttribute.option'
        db.alter_column('order_lineattribute', 'option_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, on_delete=models.SET_NULL, to=orm['catalogue.Option']))

        # Changing field 'Line.product'
        db.alter_column('order_line', 'product_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['catalogue.Product'], null=True, on_delete=models.SET_NULL))

        # Changing field 'Line.partner'
        db.alter_column('order_line', 'partner_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, on_delete=models.SET_NULL, to=orm['partner.Partner']))
    ...
    def backwards(self, orm):
        ...
        # Changing field 'LineAttribute.option'
        db.alter_column('order_lineattribute', 'option_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['catalogue.Option']))

        # Changing field 'Line.product'
        db.alter_column('order_line', 'product_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['catalogue.Product'], null=True))

        # Changing field 'Line.partner'
        db.alter_column('order_line', 'partner_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['partner.Partner']))
