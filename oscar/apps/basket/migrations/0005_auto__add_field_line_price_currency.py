...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Line.price_currency'
        db.add_column(u'basket_line', 'price_currency',
                      self.gf('django.db.models.fields.CharField')(default=settings.OSCAR_DEFAULT_CURRENCY, max_length=12),
                      keep_default=False)

    def backwards(self, orm):
        # Deleting field 'Line.price_currency'
        db.delete_column(u'basket_line', 'price_currency')
