...
class Migration(SchemaMigration):
    ...
    def backwards(self, orm):
        ...
        # Changing field 'Line.stockrecord'
        db.alter_column(u'basket_line', 'stockrecord_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['partner.StockRecord']))
    ...
    models = {
        ...
        u'basket.basket': {
            ...
            'owner': ('django.db.models.fields.related.ForeignKey', [],
                      {'related_name': "'baskets'", 'null': 'True', 'to': u"orm['{0}']".format(AUTH_USER_MODEL)}),
        ...
        u'partner.partner': {
            ...
            'users': ('django.db.models.fields.related.ManyToManyField', [],
                      {'blank': 'True', 'related_name': "'partners'", 'null':
                       'True', 'symmetrical': 'False', 'to': u"orm['{0}']".format(AUTH_USER_MODEL)})
        },
