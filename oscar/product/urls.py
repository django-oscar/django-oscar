...
from oscar.product.views import ItemDetailView, ProductListView, ItemClassListView, ItemReviewView, ReviewDetailView, ReviewListView, ReviewVoteView, simple_view
...
urlpatterns = patterns('oscar.product.views',
    ...
    #url(r'(?P<item_class_slug>[\w-]+)/(?P<item_slug>[\w-]*)-(?P<item_id>\d+)/review/(?P<review_id>\d+)/vote/$', simple_view, name='oscar-vote-review'),
