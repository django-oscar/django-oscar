...
from oscar.product.views import ItemDetailView, ProductListView, ItemClassListView,\
 ProductReviewView, ProductReviewDetailView, ProductReviewListView, ProductReviewVoteView, simple_view
...
urlpatterns = patterns('oscar.product.views',
    ...
    #url(product_url + r'/review/(?P<review_id>\d+)/$', ProductReviewVoteView.as_view(), name='oscar-vote-review'),        
