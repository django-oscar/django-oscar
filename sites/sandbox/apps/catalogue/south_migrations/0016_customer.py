...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Option.code'
        db.alter_column(u'catalogue_option', 'code', self.gf('oscar.models.fields.autoslugfield.AutoSlugField')(allow_duplicates=False, max_length=128, separator=u'-', unique=True, populate_from='name', overwrite=False))

        # Changing field 'ProductClass.slug'
        db.alter_column(u'catalogue_productclass', 'slug', self.gf('oscar.models.fields.autoslugfield.AutoSlugField')(allow_duplicates=False, max_length=128, separator=u'-', unique=True, populate_from='name', overwrite=False))

    def backwards(self, orm):

        # Changing field 'Option.code'
        db.alter_column(u'catalogue_option', 'code', self.gf('django.db.models.fields.SlugField')(max_length=128, unique=True))

        # Changing field 'ProductClass.slug'
        db.alter_column(u'catalogue_productclass', 'slug', self.gf('django.db.models.fields.SlugField')(max_length=128, unique=True))
