...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'WeightBand.upper_limit'
        db.alter_column(u'shipping_weightband', 'upper_limit', self.gf('django.db.models.fields.DecimalField')(max_digits=12, decimal_places=3))

        # Changing field 'WeightBased.default_weight'
        db.alter_column(u'shipping_weightbased', 'default_weight', self.gf('django.db.models.fields.DecimalField')(max_digits=12, decimal_places=3))

    def backwards(self, orm):

        # Changing field 'WeightBand.upper_limit'
        db.alter_column(u'shipping_weightband', 'upper_limit', self.gf('django.db.models.fields.FloatField')())

        # Changing field 'WeightBased.default_weight'
        db.alter_column(u'shipping_weightbased', 'default_weight', self.gf('django.db.models.fields.DecimalField')(max_digits=12, decimal_places=2))
    ...
    models = {
        ...
        u'shipping.weightbased': {
            ...
            'code': ('oscar.models.fields.autoslugfield.AutoSlugField', [], {'allow_duplicates': 'False', 'max_length': '128', 'separator': "u'-'", 'blank': 'True', 'unique': 'True', 'populate_from': "'name'", 'overwrite': 'False'}),
            'countries': ('django.db.models.fields.related.ManyToManyField', [], {'symmetrical': 'False', 'to': u"orm['address.Country']", 'null': 'True', 'blank': 'True'}),
            'default_weight': ('django.db.models.fields.DecimalField', [], {'default': "'0.00'", 'max_digits': '12', 'decimal_places': '3'}),
            'description': ('django.db.models.fields.TextField', [], {'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'name': ('django.db.models.fields.CharField', [], {'unique': 'True', 'max_length': '128'}),
