...
pull requests and other housekeeping. There are no notable headline features.
...
Also, ensure you test your checkout implementation after upgrading as the core
Oscar checkout view classes have been reorganised slightly.  Any upgrading work
should be minor but be diligent.
