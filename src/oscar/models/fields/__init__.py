...
class UppercaseCharField(six.with_metaclass(CharField)):
    """
...
class NullCharField(six.with_metaclass(CharField)):
    """
...
class PhoneNumberField(six.with_metaclass(CharField)):
    """
