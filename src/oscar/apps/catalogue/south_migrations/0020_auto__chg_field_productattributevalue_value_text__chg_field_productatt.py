...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column(u'catalogue_productimage', 'caption', self.gf('django.db.models.fields.CharField')(default='', max_length=200))

        # Changing field 'Product.description'
        db.alter_column(u'catalogue_product', 'description', self.gf('django.db.models.fields.TextField')(default=''))

        # Changing field 'Product.title'
        db.alter_column(u'catalogue_product', 'title', self.gf('django.db.models.fields.CharField')(default='', max_length=255))

        # Changing field 'Category.description'
        db.alter_column(u'catalogue_category', 'description', self.gf('django.db.models.fields.TextField')(default=''))

    def backwards(self, orm):

        # Changing field 'ProductImage.caption'
        db.alter_column(u'catalogue_productimage', 'caption', self.gf('django.db.models.fields.CharField')(max_length=200, null=True))

        # Changing field 'Product.description'
        db.alter_column(u'catalogue_product', 'description', self.gf('django.db.models.fields.TextField')(null=True))

        # Changing field 'Product.title'
        db.alter_column(u'catalogue_product', 'title', self.gf('django.db.models.fields.CharField')(max_length=255, null=True))

        # Changing field 'Category.description'
        db.alter_column(u'catalogue_category', 'description', self.gf('django.db.models.fields.TextField')(null=True))
