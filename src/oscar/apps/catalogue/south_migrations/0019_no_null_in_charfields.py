...
class Migration(DataMigration):
    ...
    def forwards(self, orm):
        orm.ProductImage.objects.filter(caption__isnull=True).update(caption='')
        orm.Product.objects.filter(description__isnull=True).update(description='')
        orm.Product.objects.filter(title__isnull=True).update(title='')
        orm.Category.objects.filter(description__isnull=True).update(description='')
