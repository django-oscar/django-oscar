...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Line.partner_name'
        db.alter_column(u'order_line', 'partner_name', self.gf('django.db.models.fields.CharField')(default='', max_length=128))

        # Changing field 'Line.status'
        db.alter_column(u'order_line', 'status', self.gf('django.db.models.fields.CharField')(default='', max_length=255))

        # Changing field 'Line.partner_line_reference'
        db.alter_column(u'order_line', 'partner_line_reference', self.gf('django.db.models.fields.CharField')(default='', max_length=128))

        # Changing field 'Line.partner_line_notes'
        db.alter_column(u'order_line', 'partner_line_notes', self.gf('django.db.models.fields.TextField')(default=''))

        # Changing field 'OrderDiscount.offer_name'
        db.alter_column(u'order_orderdiscount', 'offer_name', self.gf('django.db.models.fields.CharField')(default='', max_length=128))

        # Changing field 'OrderDiscount.voucher_code'
        db.alter_column(u'order_orderdiscount', 'voucher_code', self.gf('django.db.models.fields.CharField')(default='', max_length=128))

        # Changing field 'OrderDiscount.message'
        db.alter_column(u'order_orderdiscount', 'message', self.gf('django.db.models.fields.TextField')(default=''))

        # Changing field 'OrderNote.note_type'
        db.alter_column(u'order_ordernote', 'note_type', self.gf('django.db.models.fields.CharField')(default='', max_length=128))

        # Changing field 'Order.status'
        db.alter_column(u'order_order', 'status', self.gf('django.db.models.fields.CharField')(default='', max_length=100))

        # Changing field 'Order.shipping_method'
        db.alter_column(u'order_order', 'shipping_method', self.gf('django.db.models.fields.CharField')(default='', max_length=128))

        # Changing field 'Order.guest_email'
        db.alter_column(u'order_order', 'guest_email', self.gf('django.db.models.fields.EmailField')(default='', max_length=75))

        # Changing field 'BillingAddress.first_name'
        db.alter_column(u'order_billingaddress', 'first_name', self.gf('django.db.models.fields.CharField')(default='', max_length=255))

        # Changing field 'BillingAddress.title'
        db.alter_column(u'order_billingaddress', 'title', self.gf('django.db.models.fields.CharField')(default='', max_length=64))

        # Changing field 'BillingAddress.line4'
        db.alter_column(u'order_billingaddress', 'line4', self.gf('django.db.models.fields.CharField')(default='', max_length=255))

        # Changing field 'BillingAddress.line3'
        db.alter_column(u'order_billingaddress', 'line3', self.gf('django.db.models.fields.CharField')(default='', max_length=255))

        # Changing field 'BillingAddress.line2'
        db.alter_column(u'order_billingaddress', 'line2', self.gf('django.db.models.fields.CharField')(default='', max_length=255))

        # Changing field 'BillingAddress.state'
        db.alter_column(u'order_billingaddress', 'state', self.gf('django.db.models.fields.CharField')(default='', max_length=255))

        # Changing field 'BillingAddress.postcode'
        db.alter_column(u'order_billingaddress', 'postcode', self.gf('oscar.models.fields.UppercaseCharField')(default='', max_length=64))

        # Changing field 'ShippingEvent.notes'
        db.alter_column(u'order_shippingevent', 'notes', self.gf('django.db.models.fields.TextField')(default=''))

        # Changing field 'ShippingAddress.first_name'
        db.alter_column(u'order_shippingaddress', 'first_name', self.gf('django.db.models.fields.CharField')(default='', max_length=255))

        # Changing field 'ShippingAddress.title'
        db.alter_column(u'order_shippingaddress', 'title', self.gf('django.db.models.fields.CharField')(default='', max_length=64))

        # Changing field 'ShippingAddress.notes'
        db.alter_column(u'order_shippingaddress', 'notes', self.gf('django.db.models.fields.TextField')(default=''))

        # Changing field 'ShippingAddress.line4'
        db.alter_column(u'order_shippingaddress', 'line4', self.gf('django.db.models.fields.CharField')(default='', max_length=255))

        # Changing field 'ShippingAddress.line3'
        db.alter_column(u'order_shippingaddress', 'line3', self.gf('django.db.models.fields.CharField')(default='', max_length=255))

        # Changing field 'ShippingAddress.line2'
        db.alter_column(u'order_shippingaddress', 'line2', self.gf('django.db.models.fields.CharField')(default='', max_length=255))

        # Changing field 'ShippingAddress.state'
        db.alter_column(u'order_shippingaddress', 'state', self.gf('django.db.models.fields.CharField')(default='', max_length=255))

        # Changing field 'ShippingAddress.postcode'
        db.alter_column(u'order_shippingaddress', 'postcode', self.gf('oscar.models.fields.UppercaseCharField')(default='', max_length=64))

    def backwards(self, orm):

        # Changing field 'Line.partner_name'
        db.alter_column(u'order_line', 'partner_name', self.gf('django.db.models.fields.CharField')(max_length=128, null=True))

        # Changing field 'Line.status'
        db.alter_column(u'order_line', 'status', self.gf('django.db.models.fields.CharField')(max_length=255, null=True))

        # Changing field 'Line.partner_line_reference'
        db.alter_column(u'order_line', 'partner_line_reference', self.gf('django.db.models.fields.CharField')(max_length=128, null=True))

        # Changing field 'Line.partner_line_notes'
        db.alter_column(u'order_line', 'partner_line_notes', self.gf('django.db.models.fields.TextField')(null=True))

        # Changing field 'OrderDiscount.offer_name'
        db.alter_column(u'order_orderdiscount', 'offer_name', self.gf('django.db.models.fields.CharField')(max_length=128, null=True))

        # Changing field 'OrderDiscount.voucher_code'
        db.alter_column(u'order_orderdiscount', 'voucher_code', self.gf('django.db.models.fields.CharField')(max_length=128, null=True))

        # Changing field 'OrderDiscount.message'
        db.alter_column(u'order_orderdiscount', 'message', self.gf('django.db.models.fields.TextField')(null=True))

        # Changing field 'OrderNote.note_type'
        db.alter_column(u'order_ordernote', 'note_type', self.gf('django.db.models.fields.CharField')(max_length=128, null=True))

        # Changing field 'Order.status'
        db.alter_column(u'order_order', 'status', self.gf('django.db.models.fields.CharField')(max_length=100, null=True))

        # Changing field 'Order.shipping_method'
        db.alter_column(u'order_order', 'shipping_method', self.gf('django.db.models.fields.CharField')(max_length=128, null=True))

        # Changing field 'Order.guest_email'
        db.alter_column(u'order_order', 'guest_email', self.gf('django.db.models.fields.EmailField')(max_length=75, null=True))

        # Changing field 'BillingAddress.first_name'
        db.alter_column(u'order_billingaddress', 'first_name', self.gf('django.db.models.fields.CharField')(max_length=255, null=True))

        # Changing field 'BillingAddress.title'
        db.alter_column(u'order_billingaddress', 'title', self.gf('django.db.models.fields.CharField')(max_length=64, null=True))

        # Changing field 'BillingAddress.line4'
        db.alter_column(u'order_billingaddress', 'line4', self.gf('django.db.models.fields.CharField')(max_length=255, null=True))

        # Changing field 'BillingAddress.line3'
        db.alter_column(u'order_billingaddress', 'line3', self.gf('django.db.models.fields.CharField')(max_length=255, null=True))

        # Changing field 'BillingAddress.line2'
        db.alter_column(u'order_billingaddress', 'line2', self.gf('django.db.models.fields.CharField')(max_length=255, null=True))

        # Changing field 'BillingAddress.state'
        db.alter_column(u'order_billingaddress', 'state', self.gf('django.db.models.fields.CharField')(max_length=255, null=True))

        # Changing field 'BillingAddress.postcode'
        db.alter_column(u'order_billingaddress', 'postcode', self.gf('oscar.models.fields.UppercaseCharField')(max_length=64, null=True))

        # Changing field 'ShippingEvent.notes'
        db.alter_column(u'order_shippingevent', 'notes', self.gf('django.db.models.fields.TextField')(null=True))

        # Changing field 'ShippingAddress.first_name'
        db.alter_column(u'order_shippingaddress', 'first_name', self.gf('django.db.models.fields.CharField')(max_length=255, null=True))

        # Changing field 'ShippingAddress.title'
        db.alter_column(u'order_shippingaddress', 'title', self.gf('django.db.models.fields.CharField')(max_length=64, null=True))

        # Changing field 'ShippingAddress.notes'
        db.alter_column(u'order_shippingaddress', 'notes', self.gf('django.db.models.fields.TextField')(null=True))

        # Changing field 'ShippingAddress.line4'
        db.alter_column(u'order_shippingaddress', 'line4', self.gf('django.db.models.fields.CharField')(max_length=255, null=True))

        # Changing field 'ShippingAddress.line3'
        db.alter_column(u'order_shippingaddress', 'line3', self.gf('django.db.models.fields.CharField')(max_length=255, null=True))

        # Changing field 'ShippingAddress.line2'
        db.alter_column(u'order_shippingaddress', 'line2', self.gf('django.db.models.fields.CharField')(max_length=255, null=True))

        # Changing field 'ShippingAddress.state'
        db.alter_column(u'order_shippingaddress', 'state', self.gf('django.db.models.fields.CharField')(max_length=255, null=True))

        # Changing field 'ShippingAddress.postcode'
        db.alter_column(u'order_shippingaddress', 'postcode', self.gf('oscar.models.fields.UppercaseCharField')(max_length=64, null=True))
