...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'ConditionalOffer.slug'
        db.alter_column(u'offer_conditionaloffer', 'slug', self.gf('oscar.models.fields.autoslugfield.AutoSlugField')(allow_duplicates=False, max_length=128, separator=u'-', default='', unique=True, populate_from='name', overwrite=False))

    def backwards(self, orm):

        # Changing field 'ConditionalOffer.slug'
        db.alter_column(u'offer_conditionaloffer', 'slug', self.gf('django.db.models.fields.SlugField')(unique=True, max_length=128, null=True))
