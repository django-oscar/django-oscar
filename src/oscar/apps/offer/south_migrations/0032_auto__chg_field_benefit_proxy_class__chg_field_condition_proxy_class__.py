...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Benefit.proxy_class'
        db.alter_column(u'offer_benefit', 'proxy_class', self.gf('oscar.models.fields.NullCharField')(max_length=255, unique=True, null=True))

        # Changing field 'Condition.proxy_class'
        db.alter_column(u'offer_condition', 'proxy_class', self.gf('oscar.models.fields.NullCharField')(max_length=255, unique=True, null=True))

        # Changing field 'Range.proxy_class'
        db.alter_column(u'offer_range', 'proxy_class', self.gf('oscar.models.fields.NullCharField')(max_length=255, unique=True, null=True))

    def backwards(self, orm):

        # Changing field 'Benefit.proxy_class'
        db.alter_column(u'offer_benefit', 'proxy_class', self.gf('django.db.models.fields.CharField')(unique=True, max_length=255, null=True))

        # Changing field 'Condition.proxy_class'
        db.alter_column(u'offer_condition', 'proxy_class', self.gf('django.db.models.fields.CharField')(unique=True, max_length=255, null=True))

        # Changing field 'Range.proxy_class'
        db.alter_column(u'offer_range', 'proxy_class', self.gf('django.db.models.fields.CharField')(unique=True, max_length=255, null=True))
