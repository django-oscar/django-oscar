...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'SourceType.code'
        db.alter_column(u'payment_sourcetype', 'code', self.gf('oscar.models.fields.autoslugfield.AutoSlugField')(allow_duplicates=False, max_length=128, separator=u'-', unique=True, populate_from='name', overwrite=False))
        # Adding unique constraint on 'SourceType', fields ['code']
        db.create_unique(u'payment_sourcetype', ['code'])


    def backwards(self, orm):
        # Removing unique constraint on 'SourceType', fields ['code']
        db.delete_unique(u'payment_sourcetype', ['code'])


        # Changing field 'SourceType.code'
        db.alter_column(u'payment_sourcetype', 'code', self.gf('django.db.models.fields.SlugField')(max_length=128))
    ...
    models = {
        ...
        u'payment.bankcard': {
            ...
            'user': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'bankcards'", 'to': u"orm['{0}']".format(AUTH_USER_MODEL)})
        },
        u'payment.source': {
            ...
            'source_type': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'sources'", 'to': u"orm['payment.SourceType']"})
        },
