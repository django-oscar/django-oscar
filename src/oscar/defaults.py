...
OSCAR_DASHBOARD_NAVIGATION = [
    {
       ...
       "icon": '''
           <svg width="22" height="22" viewBox="0 0 22 22" fill="none" xmlns="http://www.w3.org/2000/svg">
            <path d="M21 11C21 16.5228 16.5228 21 11 21C5.47715 21 1 16.5228 1 11M21 11C21 5.47715 16.5228 1 11 1M21 11H19M1 11C1 5.47715 5.47715 1 11 1M1 11H3M11 1V3M18.0004 4L17 5M18.0004 18L17 17M4 18L5.00037 17M4 4L5 5M10.9999 8C10.9999 8 9 9.48148 9 11.5555C9 14.8148 13 14.8148 13 11.5555C13 9.48148 10.9999 8 10.9999 8Z" stroke="black" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/>
            </svg>
