...
# bulk actions
OSCAR_BULK_INTERMEDIATE_SESSION_KEY = "bulk_intermediate"
OSCAR_BULK_INTERMEDIATE_TOKEN_PARAM = "key"
OSCAR_BULK_INTERMEDIATE_SESSION_TTL_SECONDS = 3600 * 24

OSCAR_MAX_BULK_INTERMEDIATE_IDS = 500

OSCAR_PRODUCT_BULK_ACTION_MAX_DISPLAYABLE_PRODUCTS = 200
